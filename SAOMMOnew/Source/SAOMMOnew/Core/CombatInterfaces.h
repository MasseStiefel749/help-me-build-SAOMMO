...
#include "CombatInterfaces.generated.h"

/**
 *  Target-architecture attacker interface (Band 2 §8).
 *  Counterpart to the legacy Variant_Combat interfaces; lives in Core so
 *  Combat, Enemies, Character, and VR all share one contract.
 */
